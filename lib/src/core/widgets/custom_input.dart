...
class CustomTextFields extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: kTitleTextStyle(fontWeight: FontWeight.bold),
      onChanged: onChanged,
      onSaved: onSaved,
      maxLines: maxLines ?? 1,
      ...
      decoration: InputDecoration(
        ...
        labelStyle: kTitleTextStyle(size: 14, fontWeight: FontWeight.w300),
        labelText: label,
        hintText: hintText,
        focusColor: primaryColor,
        iconColor: Colors.grey,
        hintStyle: kTitleTextStyle(size: 14, fontWeight: FontWeight.w300),
